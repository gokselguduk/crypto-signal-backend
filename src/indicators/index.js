console.log('INDICATORS VERSION: 3.0 - HACIM + FIBONACCI + MULTI-TIMEFRAME');
...
function analyzeCandles(candles) {
  ...
  // Hacim konfirmasyonu
  if (vol.isHigh && score > 0) { signals.push({ type: 'BUY',  reason: 'Yuksek hacim konfirm: ' + vol.ratio + 'x' }); score += 1; }
  if (vol.isHigh && score < 0) { signals.push({ type: 'SELL', reason: 'Yuksek hacim konfirm: ' + vol.ratio + 'x' }); score -= 1; }
